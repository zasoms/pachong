...
module.exports = function(params, callback) {
    ...
    checkParams(params, function(err) {
        ...
        var titles = createColumnTitles(params, "fields");
        var subtitle = createColumnTitles(params, "subtitle");
        var csv = createColumnContent(params, titles, subtitle);
...
function checkParams(params, callback) {
    ...
    params.subtitle = params.fieldNames || "";
 ...
 */
function createColumnTitles(params, name) {
    var str = '';

    //if CSV has column title, then create it
    if (params.hasCSVColumnTitle && params[name]) {
        params[name].forEach(function(element) {
            if (str !== '') {
                str += params.del;
            }
